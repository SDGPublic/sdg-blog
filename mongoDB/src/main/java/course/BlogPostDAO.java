...
public class BlogPostDAO {
    ...
    public String addPost(String title, String body, List tags, String username) {
        ...
        post.append("author",username).append("body",body).append("date",new Date()).append("title",title).append("permalink", permalink);
        post.append("tags", tags).append("comments", new ArrayList<String>());
   ...
   // White space to protect the innocent
    ...
    public void addPostComment(final String name, final String email, final String body,
    	...
    	BasicDBObject newComment = new BasicDBObject("author", name).append("body",body);
    	if (email != null) {
    	...
    	postsCollection.update(new BasicDBObject("_id", id), new BasicDBObject("$set", new BasicDBObject("comments",comments)));
